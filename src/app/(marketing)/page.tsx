...
export default function Home() {
  return (
    <>
      ...
      <section className="relative pt-10 pb-16 md:pt-10 md:pb-20 overflow-hidden min-h-[90vh] flex flex-col justify-center">
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-industrial-blue/10 border border-industrial-blue/20 text-industrial-blue text-xs font-mono mb-8 animate-pulse">
              <Activity className="w-3 h-3" />
              <span>SYSTEMS_OPERATIONAL: READY_FOR_DEPLOYMENT</span>
            </div>

            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[0.95] md:leading-[0.9] text-white mb-8">
              Strategic Engineering<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-industrial-blue to-industrial-emerald">
                For Unstoppable Growth.
              </span>
            </h1>

            <p className="max-w-2xl text-xl text-industrial-white/60 leading-relaxed mb-12 font-light">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 border-t border-white/10 pt-12 font-mono text-center md:text-left">
      ...
      <section className="py-10 md:py-15 bg-industrial-slate relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/[0.02] border border-white/5 p-6 md:p-8 rounded-xl hover:bg-white/[0.04] transition-colors group">
            ...
            <div className="bg-white/[0.02] border border-white/5 p-6 md:p-8 rounded-xl hover:bg-white/[0.04] transition-colors group relative overflow-hidden">
      ...
      <section className="py-16 md:py-24 border-y border-white/10 bg-industrial-blue/5 relative overflow-hidden">
